    ...
    [5024], {
        ...
        19764: function(e, t, i) {
            ...
            function g(e) {
                ...
                a || (a = l > n ? "next" : l < n ? "prev" : "reset"), t.emit(`transition${r}`), i && "reset" === a ? t.emit(`slideResetTransition${r}`) : i && l !== n && (t.emit(`slideChangeTransition${r}`), "next" === a ? t.emit(`slideNextTransition${r}`) : t.emit(`slidePrevTransition${r}`))
            }
            ...
            function S(e) {
                ...
                Object.assign(s, {
                    ...
                    isScrolling: void 0,
                    startMoving: void 0
                }), l.startX = f, l.startY = m, s.touchStartTime = (0, o.f)(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, r.threshold > 0 && (s.allowThresholdMove = !1);
                let v = !0;
            ...
            function b(e) {
                ...
                if (new Date().getTime(), !1 !== l._loopSwapReset && r.isMoved && r.allowThresholdMove && w !== this.touchesDirection && S && b && Math.abs(v) >= 1) {
                    Object.assign(n, {
                        startX: p,
                        startY: h,
                        currentX: p,
                ...
                let T = !0,
                    y = l.resistanceRatio;
                if (l.touchReleaseOnEdges && (y = 0), v > 0 ? (S && b && !i && r.allowThresholdMove && r.currentTranslate > (l.centeredSlides ? this.minTranslate() - this.slidesSizesGrid[this.activeIndex + 1] - ("auto" !== l.slidesPerView && this.slides.length - l.slidesPerView >= 2 ? this.slidesSizesGrid[this.activeIndex + 1] + this.params.spaceBetween : 0) - this.params.spaceBetween : this.minTranslate()) && this.loopFix({
                        direction: "prev",
                        setTranslate: !0,
                        activeSlideIndex: 0
                    }), r.currentTranslate > this.minTranslate() && (T = !1, l.resistance && (r.currentTranslate = this.minTranslate() - 1 + (-this.minTranslate() + r.startTranslate + v) ** y))) : v < 0 && (S && b && !i && r.allowThresholdMove && r.currentTranslate < (l.centeredSlides ? this.maxTranslate() + this.slidesSizesGrid[this.slidesSizesGrid.length - 1] + this.params.spaceBetween + ("auto" !== l.slidesPerView && this.slides.length - l.slidesPerView >= 2 ? this.slidesSizesGrid[this.slidesSizesGrid.length - 1] + this.params.spaceBetween : 0) : this.maxTranslate()) && this.loopFix({
                        direction: "next",
                        setTranslate: !0,
            ...
            function T(e) {
                ...
                if (r.lastClickTime = (0, o.f)(), (0, o.n)(() => {
            ...
            let _ = {
                    ...
                    update: {
                        ...
                        updateSlides: function() {
                            ...
                            for (let r = 0; r < h; r += 1) {
                                let l;
                                if (e = 0, p[r] && (l = p[r]), M && t.grid.updateSlide(r, l, p), !p[r] || "none" !== (0, o.q)(l, "display")) {
                                    if ("auto" === s.slidesPerView) {
                                        C && (p[r].style[t.getDirectionLabel("width")] = "");
                                        let n = getComputedStyle(l),
                                            a = l.style.transform,
                                            d = l.style.webkitTransform;
                                        if (a && (l.style.transform = "none"), d && (l.style.webkitTransform = "none"), s.roundLengths) e = t.isHorizontal() ? (0, o.h)(l, "width", !0) : (0, o.h)(l, "height", !0);
                                        else {
                                            let t = i(n, "width"),
                                                s = i(n, "padding-left"),
                                                r = i(n, "padding-right"),
                            ...
                            if (Object.assign(t, {
                                ...
                                (0, o.a)(r, "--swiper-centered-offset-before", `${-f[0]}px`), (0, o.a)(r, "--swiper-centered-offset-after", `${t.size/2-v[v.length-1]/2}px`);
                                let e = -t.snapGrid[0],
                                    i = -t.slidesGrid[0];
                    ...
                    slide: {
                        slideTo: function(e, t, i, s, r) {
                            ...
                            let w = Math.min(n.params.slidesPerGroupSkip, a),
                                S = w + Math.floor((a - w) / n.params.slidesPerGroup);
                            ...
                            if (n.initialized && a !== f && (!n.allowSlideNext && (m ? b > n.translate && b > n.minTranslate() : b < n.translate && b < n.minTranslate()) || !n.allowSlidePrev && b > n.translate && b > n.maxTranslate() && (f || 0) !== a)) return !1;
                            a !== (h || 0) && i && n.emit("beforeSlideChangeStart"), n.updateProgress(b), l = a > f ? "next" : a < f ? "prev" : "reset";
                            let T = n.virtual && n.params.virtual.enabled;
                            if (!(T && r) && (m && -b === n.translate || !m && b === n.translate)) return n.updateActiveIndex(a), d.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== d.effect && n.setTranslate(b), "reset" !== l && (n.transitionStart(i, l), n.transitionEnd(i, l)), !1;
                            if (d.cssMode) {
                                let e = n.isHorizontal(),
                                    i = m ? b : -b;
                        ...
                        slideToClickedSlide: function() {
                            ...
                            let {
                                params: i,
                                slidesEl: s
                            } = t, r = "auto" === i.slidesPerView ? t.slidesPerViewDynamic() : i.slidesPerView, l = t.getSlideIndexWhenGrid(t.clickedIndex), n = t.isElement ? "swiper-slide" : `.${i.slideClass}`, a = t.grid && t.params.grid && t.params.grid.rows > 1;
                            if (i.loop) {
                                if (t.animating) return;
                                e = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10), i.centeredSlides ? t.slideToLoop(e) : l > (a ? (t.slides.length - r) / 2 - (t.params.grid.rows - 1) : t.slides.length - r) ? (t.loopFix(), l = t.getSlideIndex((0, o.e)(s, `${n}[data-swiper-slide-index="${e}"]`)[0]), (0, o.n)(() => {
                                    t.slideTo(l)
                                })) : t.slideTo(l)
                            } else t.slideTo(l)
                        }
                    ...
                    loop: {
                        loopCreate: function(e, t) {
                            ...
                            let n = s.slidesPerGroup * (l ? s.grid.rows : 1),
                        ...
                        loopFix: function(e) {
                            ...
                            let S = m.slidesPerGroupAuto ? w : m.slidesPerGroup,
                                b = v ? Math.max(S, Math.ceil(w / 2)) : S;
                            b % S != 0 && (b += S - b % S), b += m.loopAdditionalSlides, c.loopedSlides = b;
                            let T = c.grid && m.grid && m.grid.rows > 1;
                            u.length < w + b || "cards" === c.params.effect && u.length < w + 2 * b ? (0, o.v)("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : T && "row" === m.grid.fill && (0, o.v)("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
                            let y = [],
                                E = [],
                                x = T ? Math.ceil(u.length / m.grid.rows) : u.length,
                                M = n && x - g < w && !v,
                                C = M ? g : c.activeIndex;
                            void 0 === l ? l = c.getSlideIndex(u.find(e => e.classList.contains(m.slideActiveClass))) : C = l;
                            let P = "next" === s || !s,
                                k = "prev" === s || !s,
                                O = 0,
                                _ = 0,
                            ...
                            if (L < b) {
                                ...
                                _ = Math.max(L - (x - 2 * b), S), M && (_ = Math.max(_, w - x + g + 1));
                                for (let e = 0; e < _; e += 1) {
                                    let t = e - Math.floor(e / x) * x;
                                    T ? u.forEach((e, i) => {
                                        e.column === t && E.push(i)
                            ...
                            if (c.__preventObserver__ = !0, requestAnimationFrame(() => {
                                ...
                                }), "cards" === c.params.effect && u.length < w + 2 * b && (E.includes(l) && E.splice(E.indexOf(l), 1), y.includes(l) && y.splice(y.indexOf(l), 1)), k && y.forEach(e => {
                                ...
                                if (y.length > 0 && k) {
                                    if (void 0 === t) {
                                        ...
                                        d ? c.setTranslate(c.translate - t) : (c.slideTo(C + Math.ceil(O), 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                                    } else if (r) {
                                    ...
                                    if (void 0 === t) {
                                        ...
                                        d ? c.setTranslate(c.translate - t) : (c.slideTo(C - _, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                                    } else {
                    ...
                    events: {
                        attachEvents: function() {
                            ...
                            this.onTouchStart = S.bind(this), this.onTouchMove = b.bind(this), this.onTouchEnd = T.bind(this), this.onDocumentTouchStart = C.bind(this), e.cssMode && (this.onScroll = x.bind(this)), this.onClick = E.bind(this), this.onLoad = M.bind(this), P(this, "on")
                        },
                    ...
                    breakpoints: {
                        setBreakpoint: function() {
                            ...
                            let w = p.direction && p.direction !== s.direction,
                                S = s.loop && (p.slidesPerView !== s.slidesPerView || w),
                                b = s.loop;
                            w && i && e.changeDirection(), (0, o.x)(e.params, p);
                            ...
                            }), g && !T ? e.disable() : !g && T && e.enable(), e.currentBreakpoint = u, e.emit("_beforeBreakpoint", p), i && (S ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !b && y ? (e.loopCreate(t), e.updateSlides()) : b && !y && e.loopDestroy()), e.emit("breakpoint", p)
                        },
            ...
            class I {
                constructor() {
                    ...
                    1 === s.length && s[0].constructor && "Object" === Object.prototype.toString.call(s[0]).slice(8, -1) ? t = s[0] : [e, t] = s, t || (t = {}), t = (0, o.x)({}, t), e && !t.el && (t.el = e);
                    let l = (0, a.g)();
                    ...
                    let h = (0, o.x)({}, O, p);
                    return n.params = (0, o.x)({}, h, L, t), n.originalParams = (0, o.x)({}, n.params), n.passedParams = (0, o.x)({}, t), n.params && n.params.on && Object.keys(n.params.on).forEach(e => {
                ...
                getSlideIndex(e) {
                    let {
                        slidesEl: t,
                        params: i
                    } = this, s = (0, o.e)(t, `.${i.slideClass}, swiper-slide`), r = (0, o.i)(s[0]);
                    return (0, o.i)(e) - r
                }
            ...
            function G(e, t) {
                let i = ["__proto__", "constructor", "prototype"];
                Object.keys(t).filter(e => 0 > i.indexOf(e)).forEach(i => {
                    void 0 === e[i] ? e[i] = t[i] : z(t[i]) && z(e[i]) && Object.keys(t[i]).length > 0 ? t[i].__swiper__ ? e[i] = t[i] : G(e[i], t[i]) : e[i] = t[i]
                })
            }
            ...
            let H = (0, n.createContext)(null),
                ...
                X = (0, n.forwardRef)(function(e, t) {
                    ...
                    let {
                        ...
                        onSwiper: d,
                        ...c
                    } = void 0 === e ? {} : e, u = !1, [p, h] = (0, n.useState)("swiper"), [f, m] = (0, n.useState)(null), [v, g] = (0, n.useState)(!1), w = (0, n.useRef)(!1), S = (0, n.useRef)(null), b = (0, n.useRef)(null), T = (0, n.useRef)(null), y = (0, n.useRef)(null), E = (0, n.useRef)(null), x = (0, n.useRef)(null), M = (0, n.useRef)(null), C = (0, n.useRef)(null), {
                        params: P,
                        passedParams: k,
                        rest: _,
                        events: L
                        ...
                        let i = {
                            ...
                            s = {},
                            r = {};
                        G(i, O), i._emitClasses = !0, i.init = !1;
                        let l = {},
                            n = A.map(e => e.replace(/_/, ""));
                        return Object.keys(Object.assign({}, e)).forEach(a => {
                            void 0 !== e[a] && (n.indexOf(a) >= 0 ? z(e[a]) ? (i[a] = {}, r[a] = {}, G(i[a], e[a]), G(r[a], e[a])) : (i[a] = e[a], r[a] = e[a]) : 0 === a.search(/on[A-Z]/) && "function" == typeof e[a] ? t ? s[`${a[2].toLowerCase()}${a.substr(3)}`] = e[a] : i.on[`${a[2].toLowerCase()}${a.substr(3)}`] = e[a] : l[a] = e[a])
                    ...
                    S.current || Y(), b.current && b.current.on("_beforeBreakpoint", X);
                    let U = () => {
                            !u && L && b.current && Object.keys(L).forEach(e => {
                                b.current.on(e, L[e])
                            })
                        },
                        K = () => {
                    ...
                    return (0, n.useEffect)(() => () => {
                        ...
                        if (t && (t.current = S.current), S.current) return b.current.destroyed && Y(),
                            function(e, t) {
                                let {
                                    el: i,
                                    nextEl: s,
                                ...
                                D(t) && s && r && (a.params.navigation.nextEl = s, a.originalParams.navigation.nextEl = s, a.params.navigation.prevEl = r, a.originalParams.navigation.prevEl = r), N(t) && l && (a.params.pagination.el = l, a.originalParams.pagination.el = l), V(t) && n && (a.params.scrollbar.el = n, a.originalParams.scrollbar.el = n), a.init(i)
                            }({
                                el: S.current,
                                nextEl: E.current,
                                prevEl: x.current,
                                ...
                                swiper: b.current
                            }, P), d && !b.current.destroyed && d(b.current), () => {
                        ...
                        }(k, T.current, H, y.current, e => e.key);
                        return T.current = k, y.current = H, e.length && b.current && !b.current.destroyed && function(e) {
                            let t, i, s, r, l, n, a, d, {
                                    swiper: c,
                                    slides: u,
                                    passedParams: p,
                                ...
                                w = h.filter(e => "children" !== e && "direction" !== e && "wrapperClass" !== e),
                                {
                                    params: S,
                                    pagination: b,
                                    navigation: T,
                    ...
                    }(b.current, H, f) : H.map((e, t) => n.cloneElement(e, {
                        swiper: b.current,
                        swiperSlideIndex: t
                    })), W["wrapper-end"]), D(P) && n.createElement(n.Fragment, null, n.createElement("div", {
                        ref: x,
            ...
            let Y = (0, n.forwardRef)(function(e, t) {
                ...
                }, u), a && n.createElement(H.Provider, {
                    value: w
                }, n.createElement("div", {
